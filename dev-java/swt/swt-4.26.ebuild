...
MY_PV="${PV/_rc/RC}"
MY_DMF="https://archive.eclipse.org/eclipse/downloads/drops4/R-${MY_PV}-202211231800"
MY_P="${PN}-${MY_PV}"
...
src_prepare() {
	...
	sed -i '1s/^/GThread *g_thread_new (const gchar *name, GThreadFunc func, gpointer data);\n\n/' "${S}"/os_custom.h || die
